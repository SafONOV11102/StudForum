...
namespace StudForum.Services
{
    public class JwtService
    {
        private string secureKey = "@MySecuryPassword@27777772999@MyPassword#Nf#fsdlkjdf#1231#FSD%DFS";

        public string Generate(string login, int userId, string name, string surname)
        {
